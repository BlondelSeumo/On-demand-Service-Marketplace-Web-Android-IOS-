...
public class ViewAllNewServicesFragment extends Fragment implements RetrofitHandler.RetrofitResHandler {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tvServices.setText(AppUtils.cleanLangStr(getActivity(),
                viewAllStringsList.getLblNewService().getName(), R.string.txt_new_services));

        getViewAllServices("New");
        return mView;
    }
