...
import com.dreamguys.truelysell.TabBar.badgeview.BadgeRelativeLayout;
import com.dreamguys.truelysell.TabBar.badgeview.Badgeable;
import com.dreamguys.truelysell.TabBar.badgeview.DragDismissDelegate;
 ...
 * TabBarItem类
 */
public class CustomTabItem extends BadgeRelativeLayout {
    //颜色渐变时间
    ...
    public void setSelectIcon(int selectIcon) {
        ...
        mSelectIcon.setTintList(ColorStateList.valueOf(mSelectColor));
        mSelectIcon.setTintMode(PorterDuff.Mode.SRC_ATOP);
        updateIcon();
    }
    ...
    static class Builder {
        ...
        CustomTabItem build() {
            CustomTabItem item = new CustomTabItem(context);
