...
public class ServiceDetailOverviewFragment extends Fragment {
    ...
    public ServiceDetailOverviewFragment() {

    }

    public ServiceDetailOverviewFragment(GETServiceDetails.ServiceOverview serviceOverview) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        forecastAdapter = new ForecastAdapter(serviceOverview.getServiceImage());
        ...
        if (serviceOverview != null) {
            ...
            tvViews.setText(serviceOverview.getViews() + " Views");
            tvRatingCount.setText("(" + serviceOverview.getRating_count() + ")");
            description.setText(AppUtils.cleanLangStr(getActivity(),bookingServiceScreenList.getLblDescription().getName(), R.string.txt_description));
            serviceOffered.setText(AppUtils.cleanLangStr(getActivity(),bookingServiceScreenList.getLblServiceOffered().getName(), R.string.txt_service_offered));
            if (serviceOverview.getService_offered() != null) {
                try {
                    JSONArray descList = new JSONArray(serviceOverview.getService_offered());
